import type { ButtonProps, FormItemRule, FormRules, FormProps as NaiveFormProps } from 'naive-ui';
...
export interface FormCommonConfig extends NaiveFormProps {
  /**
   * 在Label后显示一个冒号
   */
  colon?: boolean;
...
export interface FormAdapterOptions<T extends BaseFormComponentType = BaseFormComponentType> {
  config?: {
